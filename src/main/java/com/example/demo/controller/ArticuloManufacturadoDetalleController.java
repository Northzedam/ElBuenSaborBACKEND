...
import com.example.dtos.ArticuloManufacturadoDetalleDto;
...
public class ArticuloManufacturadoDetalleController{
	...
	protected ArticuloManufacturadoDetalleServicio service;
	...
	@PostMapping("/")
	@Transactional
	public ResponseEntity<?> post(@RequestBody ArticuloManufacturadoDetalleDto dto) {
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<?> put(@PathVariable int id, @RequestBody ArticuloManufacturadoDetalleDto dto) {
