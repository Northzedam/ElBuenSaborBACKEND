...
import com.example.demo.service.EstadoPedidoServicio;

@RestController
@CrossOrigin(origins = "*", methods = {RequestMethod.GET, RequestMethod.DELETE, RequestMethod.POST, RequestMethod.PUT})
@RequestMapping(path = "api/v1/estadoPedido")
public class EstadoPedidoController {
	
	@Autowired (required = true)
	protected EstadoPedidoServicio service;
	...
	//getAll-----------------------
		...
		@PostMapping("/")
		@Transactional
		public ResponseEntity post(@RequestBody EstadoPedidoDto dto) {
		...
		@PutMapping("/{id}")
		@Transactional
		public ResponseEntity put(@PathVariable int id, @RequestBody EstadoPedidoDto dto) {
