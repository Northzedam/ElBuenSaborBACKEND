...
import com.example.demo.service.ArticuloServicio;
...
public class ArticuloController{
	...
	protected ArticuloServicio service;
	...
	@Transactional
	public ResponseEntity post(@RequestBody ArticuloDto dto) {
	...
	@Transactional
	public ResponseEntity put(@PathVariable int id, @RequestBody ArticuloDto dto) {
