...
public class RubroGeneralController {
	...
	protected RubroGeneralServicio service;
	...
	@PostMapping("/")
	@Transactional
	public ResponseEntity post(@RequestBody RubroGeneralDto dto) {
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<?> put(@PathVariable int id, @RequestBody RubroGeneralDto dto) {
