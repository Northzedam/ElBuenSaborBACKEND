...
import com.example.dtos.FacturaDto;
import com.example.demo.entity.Factura;
import com.example.demo.service.FacturaServicio;
...
public class FacturaController{
	...
	protected FacturaServicio service;
	...
	@PostMapping("/")
	@Transactional
	public ResponseEntity<?> post(@RequestBody FacturaConsumoDto dto) {
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<?> put(@PathVariable int id, @RequestBody FacturaConsumoDto dto) {
