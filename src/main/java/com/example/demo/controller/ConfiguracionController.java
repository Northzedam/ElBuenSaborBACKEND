...
import com.example.dtos.ConfiguracionDto;
import com.example.demo.entity.Configuracion;
import com.example.demo.service.ConfiguracionServicio;
...
public class ConfiguracionController{
	...
	protected ConfiguracionServicio service;
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<?> put(@PathVariable int id, @RequestBody ConfiguracionDto dto) {
